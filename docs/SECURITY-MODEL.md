...
|-------|-------|-------------|--------------------------------|
| Smart contracts | 🟡 | 8 UUPS contracts, 91 tests, internal audit (1C/3H/3M fixed + regressions), governance + timelock module, live on Robinhood Chain testnet | External audit; storage `__gap`s; make BLS the sole verification path + redeploy |
